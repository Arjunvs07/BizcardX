...
if select == "Home":
    ...
    st.write("### :green[**About :**] Bizcard is a python application designed to extract image details from the Business cards.")

    st.write("### The main purpose of Bizcard is to automate the process of extracting key details from the business card images,such as the name,designation,company,contact information and other relevant data.By leveraging the power of OCR(Optical Character Recognition) provided by Easy OCR ,Bizcard is able to extract text from images ")
